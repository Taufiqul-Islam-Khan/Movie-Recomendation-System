...
library(recommenderlab) # for recomendation
library(ggplot2)                       
library(data.table)
library(reshape2) # for visualization

# Retriving the data 
movie_data <- read.csv("H:/SEBPO/Data Science/IRMANA/movies.csv",stringsAsFactors=FALSE)
rating_data <- read.csv("H:/SEBPO/Data Science/IRMANA/ratings.csv")
#structure
str(movie_data)
str(rating_data)
...
# Many movies have several gnere. So, lets create a sparse matrix for recomendation
...
#we delineate the similarity that is shared between the films 
...
#most viewed movie viualization
library(ggplot2)
